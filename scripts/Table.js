...
function loadUserInformation()
{
  ...
  if(user != null)
  {
    ...
    $("#divUserSection").append("User's Name:"+user.FirstName+" "+user.LastName+"<br>Age: "+age+"<br>New Password : "+user.NewPassword);
  ...
  if(tbRecords != null)
  {
    ...
    for(var i=0;i<tbRecords.length;i++)
    {
      ...
      $("#tblRecords tbody").append("<tr>"+
         ...
         "  <td>"+" "+rec.Height+"</td>" +
         "  <td>"+" "+rec.Weight+"</td>" +
         "  <td>"+" "+rec.Weight/(rec.Height*rec.Height)+"</td>" +
...
function showRecordForm(index)
{
  try
  {
    ...
    $('#numHeight').val(rec.Height);
    $('#numWeight').val(rec.Weight);
  }
  catch(e)
  {
    /* Google browsers use different error
...
function addRecord()
{
  if(checkRecordForm())
  {
    var record={
      ...
      "Height"            : $('#numHeight').val(),
      "Weight"             : $('#numWeight').val()
    };
